...
tad atyantāsaṃgatam, caturthasya pramāṇasiddhasya pratipāditatvāt pratipādayiṣyamāṇatvāc ceti.\footnoteA{
	Tib.\ discusses two further \emph{pakṣa}s here: that the fourth referred to in \emph{Samājottara} 113f is the fourth \emph{aṅga} of \emph{sevā} and so forth; and what appears to be the idea that the fourth initiation consists in the third accompanied by its fruits (\emph{'bras bu dang bcas pa}).
...
} paraṃ vyāmohaḥ. tad vicāryate. lakṣyaṃ hi bhavad\footnoteB{
...
\begin{quote}
	mithyādhyāropahānārthaṃ\footnoteB{
		...
		moktari] \emd\ (\TVA : grol byed; \TVB grol ba po); bhoktarī° \MS\ (\emph{the letter} no \emph{is added above} bho); muktaye \EDD\ (\emd)
	}\footnoteA{
...
% § 8.4
\subsubsection{caturthasya sārāsāravicāraṇam}
...
bhrāntirūpatvenāparamārthatvam api sarvatraiva bhāvanāviṣaye vastuni\footnoteB{
	...
	The text could be rendered in Sanskrit as follows: \emph{(prapañcālambanasya) bhrāntirūpatvenāparamārthatvam iti cet, sarvatraiva bhāvanāviṣayāṇāṃ vastūnāṃ sambhrāntatvān na kiñcid api bhāvanīyaṃ syāt}.%
}
...
} aduṣṭaṃ bhavatīti cet.
nanv\footnoteB{
	nanv] \emd\ (\textsc{Isaacson}); na tv \MS\ \EDD
} ayaṃ māyākārānupraveśaḥ prapañce 'pi samāna iti.
tatrāpi ko doṣasyāvakāśaḥ?
tasmāt\footnoteB{
	tasmāt] \MS\ \EDD ; de bas na don du gnyer bas \TIB\ (tasmād arthī)
...
\noindent tṛtīyapakṣoktadoṣān\footnoteB{
	tṛtīyapakṣoktadoṣān] \conj\ (\TVB : gsum pa'i phyogs la bshad pa'i nyes pa yod pa dang); tṛtīyapakṣe ktato \MS ; tṛtīyapakṣe kuto \EDD ; gsum pa'i phyogs la bshad pa'i nyes pa \TVA\ (\emph{see note} concerning \TVA )
	...
	Here, however, if that argument is further qualified with \emph{nīrasatvena}, its inclusion as a different reason is cogent—unlike the fifth \emph{pakṣa}, the third includes bliss as an integral part of the \emph{sādhya}.
...
\noindent svecchayā nirvāpayitum\footnoteB{
	nirvāpayitum] \EDD ; nirvāyayitum \MS 
} aśakyatvāt, prayojanābhāvāt, sattvārthābhāvāc ca na pañcāntaprabhedakalpanā\footnoteB{
	pañcānta°] \emd\ \TIB\ (lnga pa'i mtha'i); prapañcāntara° \MS\ \EDD
} kalaṅkaśūnyā.\footnoteB{
	kalaṅkaśūnyā] \emd\ (\textsc{Isaacson}); kalaṅkāśūnyā \MS\ \EDD
}\footnoteA{
...
} vahnir niḥśeṣam indhanaṃ bhasmīkṛtya paścāt svarasata eva nivartate, tathā maṇḍalacakraprajvalitaḥ śūnyatājñānāgniḥ sākṣāt kṛtam api\footnoteB{
	sākṣāt kṛtam api] \conj ; sākṣān \MS\ \EDD ; mngon sum du byas nas kyang \TIB\ (sākṣāt kṛtvāpi)
} maṇḍalacakraṃ nivartayiṣyatīti cet.\footnoteA{
	\TIB\ provides a fuller sentence here. \TVB\ reads: \emph{de ltar dkyil 'khor gyi 'khor lo stong pa nyid kyi ye shes kyi me rab tu 'bar bas mngon sum du byas nas kyang | dkyil 'khor gyi 'khor lo ma lus par ldog par byed la | bdag nyid kyang rang gi ngang gis ldog par 'gyur ro zhe na |}; \ldots\ \emph{kṛtvāpy} (or \emph{kṛtam api}) \emph{aśeṣamaṇḍalacakraṃ nivartya svayam api svarasato nivartate}.% nivartsyate or nivartiṣṭyati for future

	\hspace*{1em}\TVA\ appears to be slightly more corrupt, but suggests roughly the same text: \emph{de dkyil 'khor gyi 'khor lo stong pa nyid kyi ye shes kyi me rab tu 'bar bas mngon sum du byas nas kyang | dkyil 'khor gyi 'khor lo ma lus par ldog par byed la | de yang rang gi ldog par 'gyur ro zhe na |} 
...
na\footnoteB{
	...
	\TIB\ diverges significantly in this section: \emph{'di ltar de la shing 'gyur bar byed pa'i rgyur gyur pa'i me ni shing 'gyur ba yang dag par skyed pa nyid kyis | shing 'gyur bar byed pa ni me yin no zhes 'jig rten pa rnams sems la | 'dir ni stong pa nyid ni dkyil 'khor gyi 'khor lo 'gyur bar byed pa'i rgyu ma yin na | de'i phyir de ldog par byed pa yin | stong pa nyid la rang gi ngang gis ldog go zhes kyang smra bar bya ba ma yin no ||} (\TVB)	
	...
	\hspace*{1em}
	It seems \emph{'gyur bar byed pa'i rgyu} may translate either \emph{vikārakāraṇa} or simply \emph{kāraṇa}.
	\TVB\ can be roughly rendered in Sanskrit as follows: \emph{tathā hi tatrendhana(vikāra)kāraṇabhūtasya vahner indhanavikārasamutpādanād indhanasya vikartā vahnir iti manyate lokaḥ.
	iha tu na śūnyatā (vikāra)kāraṇaṃ maṇḍalacakrasya.
	tatas tannivartikā śūnyatā svarasata eva nivartata iti na vaktavyam.}
	In English the passage can be translated follows: `To explain, in [the example], fire, as the cause of transformation in wood, creates a transformation in wood, and by this common people believe that fire transforms wood. In this case, however, emptiness is not a cause for a transformation in the \emph{maṇḍala}. Therefore, one cannot say that this [emptiness] is a cause of cessation, nor that emptiness will cease of its own accord.'
...
na ca nirodhya\footnoteB{
	nirodhya] \EDD ; niro((dhya)) \MS\ (\emph{some kind of correction is made, but uncertain from what to what}); 'gogs pa las (\emph{possibly} nirodhāt)
...
\noindent ṣaṣṭhapakṣoktadoṣasandohasya saptame\footnoteB{
	ṣaṣṭhapakṣoktadoṣasandohasya saptame] \conj\ (\TVB : drug pa'i phyogs la bshad pa'i skyon gyi tshogs bdun pa la) (\TVA : \emph{same as} \TVB , \emph{with} gyis \emph{for} gyi); ṣaṣṭhapakṣoktaṃ saṃdāhasyāṣṭame \MS ; ṣaṣṭhapakṣoktasaṃdohasyāṣṭame \EDD
...
nanu ṣaṣṭhena saptamasya samānatvāt kathaṃ saptamasya tato viśeṣaḥ?\footnoteB{
	saptamasya tato viśeṣaḥ] \MS\ \EDD\ \TVB\ (de las bdun pa khyad par ci yod); de la khyad par ci yod \TVA\ (tatra ko viśeṣaḥ)
}
asti viśeṣaḥ.
...
etad uktaṃ bhavati\emdash mukhaśravaṇacakṣurghrāṇarasanāni\footnoteB{
	...
	It is not entirely clear what body parts should be included in this compound, given \TIB\ omits the tongue and \MS\ includes the nose twice.
	Provisionally we adopt a reading with only one instance of the nose and includes the tongue.
	It is true that the tongue is slightly out of place, since the other elements are evidently orifices on the face.
...
sā ca [\EDD\ p.\ 148] jihvāgreṇa spṛśyamānā nirantarāmṛtaṃ sravati.\footnoteA{
	Like the English verb 'to flow', the Sanskrit √\emph{sru} is ambitransitive, although appears to be used intransitively in greater frequency.
}
...
ādiśabdena hṛnmadhyaṣoḍaśanāḍikācakramadhyasthajñānasvarūpaṃ\footnoteB{
	...
	\TIB\ continues to describe this practice in a citation, likely composed in an elaborate Sanskrit metre. \emph{yang smras pa | bcu las drug lhag rtsa dang ldan pa'i 'khor lo yi || dkyil na gnas pa'i snying gar rnam par gnas pa'i bdag | des ni de yi khyad par lta bu'i grub pa ster || de ni mngon par mi g-yo ba yi yid dag gis || rnal 'byor pa yi sems de de ltar mngon par bsam || nub par gyur pa'i mgon po rgyal bar gyur de ni || nus pa dag gis de ni yongs su bskor dang bcas ||} (\TVA). \emph{de yang smras pa | bcu las drug lhag rtsa dang ldan pa'i 'khor lo'i dkyil na gnas pa snying kar rnam par gnas pa'i bdag | des ni de'i khyad par lta bu yi grub pa ster | de ni mngon par mi g.yo ba'i yid dag gis || rnal 'byor pa yis de ltar mngon par bsam par bya || nus par gyur pa'i mgon po rgyal bar gyur || de ni nus pa dag gis de ni yongs su bskyor dang bcas ||} (\TVB)

	\hspace*{1em} Neither translation is transmitted particularly well here, and the original was likely obscure. A very provisional English rendering mostly following \TVB\ may read: `The self is situated on in the middle of a cakra with sixteen spokes/channels and resides in the heart. It grants \emph{siddhi} as if with those characteristics (? - \emph{de yi khyad par lta bu}). With a mind that does not waver, a \emph{yogin} should contemplate it thus. The lord having become \emph{śakti} reigns supreme. Through \emph{śakti} he is surrounded by a retinue (? - read \emph{bskor} for \emph{bskyor}).'
}
...
} ādiśabdāt śivaṃ nirākāraṃ niṣprapañcam anādidhanam\footnoteB{
	anādinidhanam] \conj ; anādyantanidhanam \MS\ \EDD ; anādyantam \possibleconj
} i[\MS\ fol.\ 10v]\hspace*{0em}tyādiśabdair bhrāntir na kartavyāparasādhyasattva 'parasya sādhyasya sattve sattāyām.\footnoteB{
	sattāyām] \MS ; sattvāyā \EDD
} ebhiḥ śabdair\footnoteB{
	śabdair] \conj\ (\TIB : sgra); sarvair \MS\ \EDD
} eva param api kiñcit sādhyaṃ kathitād astīti bhrāntir na kartavyā.
athavā\footnoteB{
	athavā] \conj ; atha \MS\ \EDD ; \emph{no reflex in} \TIB
} nātikathitam\footnoteA{
	Tibetan expresses the idea of this sentence in a different way: 
	\emph{bshad pa'i bsgrub par bya ba kho na de dag thams cad kyis brjod par bya ba yin zhes nges par bya'o} || (\TVA) \emph{bshad pa bsgrub bya kho na de dag thams cad kyis brjod par bya ba yin zhes nges par bya'o} || (\TVB); `One should be certain that only the goals that were taught are directly expressed by all of these [words]'.
} eva sādhyam ebhiḥ sarvair abhidhīyata iti niścayaḥ.
