...
\noindent śobhanāni ca tāni lakṣaṇāni ca dvātriṃśallakṣaṇasaṃjñakāni,\footnoteB{
	dvātriṃśallakṣaṇasaṃjñakāni] \conj ; dvātriṃśallakṣaṇasaṃjñakāni ceti \MS\ \EDD ; mdzes pa'i mtshan sum cu rtsa gnyis zhes bya ste \TIB\ (dvātriṃśatsallakṣaṇānīti)
}\footnoteA{
	The manuscript reading \emph{ceti} after \emph{dvātriṃśallakṣaṇasaṃjñakāni} appear superfluous.
	The commentary analyses \emph{sallakṣaṇa} as a \emph{karmadhāraya}, glossing \emph{sat} with \emph{śobhana}; \emph{dvātriṃśallakṣaṇa} serves as a further clarification, requiring no further conjunction.
