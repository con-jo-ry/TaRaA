...
lakṣyate 'neneti lakṣaṇam anubhūyamānaṃ prajñājñānam, apratīyamānasya lakṣaṇatvāyogāt, nāgṛhītaviśeṣaṇā [\EDD\ p.\ 141]viśeṣyabuddhir iti nyāyāt. lakṣyate jñāyate pratipādyate\footnoteB{
	...
	By normal conventions the \emph{anena} here would indicate that the word being glossed, \emph{lakṣyaṃ} in this case, denotes the agent of verbal root.
...
ucyate.\footnoteB{
	...
	Again \TVA\ demonstrates more simplified language.
}
sukhākāraṃ vijñānam \footnoteB{
	...
	\TVA\ is likely corrupt or wrong edited with \emph{shes pa rnams ni} in place of \TVB 's \emph{shes pa'i nang na}.
...
nanv anena nyāyena sakalasākāranirākāravijñānasyā\footnoteB{
	...
	The \emph{iti} following \emph{asti} in the \MS\ is superfluous with \emph{tat} starting the next sentence in the sense of \emph{tasmāt}, continuing the objection.
...
tatraiva cālīke pratibhāsamātre lakṣyalakṣaṇasaṃsāranirvāṇa[\MS\ fol.\ 7v]maṇḍalacakrādibhāvanāsakalajaga\-da\-rtha\-kri\-yā\-dī\-nām\footnoteB{
	...
	\hspace*{1em}Here too the \MS\ seems to transmit a superfluous \emph{iti}, here following \emph{sidhyati}.
} tathā coktam\emdash 
...
nirupadravabhūtārthasvabhāvatvena sātmībhūtasya tyaktum aśakyatvāt, saṃvalitarūpasya [\EDD\ p.\ 144] bhedābhāvāt, prayojanābhāvāc ca na tṛtīyasya kalyāṇabhāvaḥ.\footnoteB{
	...
	The reading of \ED\ (either a silent emendation or a misreading of the manuscript), \emph{na tṛtīyaḥ kalpanābhāvaḥ}, gives some sense (`the third is not without conceptual construction') but it is missing a masculine headword.
	There are indeed be other options to emend the \MS 's reading, such as \emph{na tṛtīyasya kalyāṇatā} or perhaps \emph{na tṛtīyasya kalpanābhāvam}.
...
atra kecid yuktiṃ varṇayanti.\footnoteA{
	...
	It is possible that the sentence is corrupt (especially the \emph{las} after \emph{'ga' zhig}).
	How to interpret it in the overal structure of the text is not obvious.
...
} dīrghakālaṃ ca tatraiva sthirībhavatīty āgamaḥ. yuktiś cātrāsti.\footnoteB{
	°īty āgamaḥ. yuktiś cātrāsti] \MS\ (°ity āgamaḥ |) \EDD\ \TVB\ (zhes bya ba ni lung yin no || 'di la rigs pa yang yod de |); zhes bya ba ni lung yin no || 'di la rigs pa yang yod de | \TVB\ (°iti yuktiḥ. āgamaś cātrāsti)
} tathā coktam—
